...
\cvaddress{}
\cvjobtitle{Étudiant Ingénieur en mathématiques appliqués et modélisation en recherche d'une alternance en Data Science d'une année à partir de\\ Septembre}
\cvsite{hamzaokd.com}
...
\begin{textblock}{20.5}(0.25, 4.5)
  ...
  \begin{minipage}[t]{0.37\textwidth}
    ...
    \sectionleft{Compétences techniques}
        ...
        - Anglais(niveau B2, TOEIC :940/990)\\
        - Français .
        }
